...
namespace Nemiro
{
  ...
  public static partial class Convertion
  {
    ...
    public static UInt32? ToUInt32(object value, UInt32? @default)
    {
      if (!Convertion.HasValue(value)) { return @default; }
      decimal? result = Convertion.ToDecimal(value, null);
      if (!result.HasValue || result.Value < UInt32.MinValue || result.Value > UInt32.MaxValue)
      {
        return @default;
      }
    ...
    public static UInt32 ToUInt32(object value, UInt32 @default)
    {
      return Convertion.ToUInt32(value, (UInt32?)@default).GetValueOrDefault(@default);
    }
    ...
    {
      return Convertion.ToUInt32(value, null).GetValueOrDefault();
    }
