...
namespace Nemiro
{
  ...
  public static partial class Convertion
  {
    ...
    public static UInt16? ToUInt16(object value, UInt16? @default)
    {
      if (!Convertion.HasValue(value)) { return @default; }
      decimal? result = Convertion.ToDecimal(value, null);
      if (!result.HasValue || result.Value < UInt16.MinValue || result.Value > UInt16.MaxValue)
      {
        return @default;
      }
    ...
    public static UInt16 ToUInt16(object value, UInt16 @default)
    {
      return Convertion.ToUInt16(value, (UInt16?)@default).GetValueOrDefault(@default);
    }
    ...
    {
      return Convertion.ToUInt16(value, null).GetValueOrDefault();
    }
